...
\addtocategory{paper}{paper:pix2pix}
\addtocategory{paper}{paper:heusel2017gans}
\addtocategory{paper}{paper:salimans2016improved}
\addtocategory{paper}{paper:esrgan}
\addtocategory{paper}{paper:ganeval}
\addtocategory{paper}{paper:rapidscenecat}

\addtocategory{opere}{womak:lean-thinking}
\addtocategory{web}{site:agile-manifesto}
\addtocategory{web}{site:opencv-threshold}
\addtocategory{web}{site:opencv-canny}
\addtocategory{web}{site:sckit-meijering}


\defbibheading{opere}{\section*{Bibliographical references}}
\defbibheading{web}{\section*{Websites consulted}}
\defbibheading{paper}{\section*{Papers consulted}}
...
\addto\captionsitalian{\renewcommand{\figurename}{Fig.}
                        ...
                        \renewcommand{\indexname}{Index}
                        \renewcommand{\listtablename}{List of Tablesgit}
